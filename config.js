...
const VEH = {
  ...
  plane:   { spd: 0.0042,   em: '&#9992;',   lbl: 'PLANE',  kmh: '850 km/h' }, // default, overridden by aircraft
  ufo:     { spd: 0.0075,   em: '&#128760;', lbl: 'UFO',    kmh: '\u221E km/h' },
};

// Aircraft types with real speeds
const AIRCRAFT = [
  { id: 'cessna',  name: 'Cessna 172',       kmh: 230,  spd: 0.0014,  color: '#88cc44', desc: 'Light prop' },
  { id: 'boeing',  name: 'Boeing 747',       kmh: 920,  spd: 0.0052,  color: '#00bfff', desc: 'Jumbo jet' },
  { id: 'a320',    name: 'Airbus A320',      kmh: 840,  spd: 0.0048,  color: '#44aaff', desc: 'Workhorse' },
  { id: 'concorde',name: 'Concorde',         kmh: 2180, spd: 0.012,   color: '#ff6600', desc: 'Mach 2' },
  { id: 'f16',     name: 'F-16 Falcon',      kmh: 2414, spd: 0.014,   color: '#ff2244', desc: 'Mach 2+' },
  { id: 'sr71',    name: 'SR-71 Blackbird',  kmh: 3540, spd: 0.020,   color: '#cc44ff', desc: 'Mach 3.3' },
  { id: 'bomber',  name: 'B-2 Spirit',       kmh: 1010, spd: 0.0058,  color: '#666',    desc: 'Stealth' },
  { id: 'x15',     name: 'X-15 Rocket',      kmh: 7274, spd: 0.042,   color: '#ff4400', desc: 'Mach 6.7!' },
];

const ZOOM_LEVELS = [
  { z: 3,  name: 'Continental', desc: 'Continents',   tileZ: 3  },
  { z: 5,  name: 'Country',     desc: 'Countries',    tileZ: 5  },
  { z: 7,  name: 'Region',      desc: 'Regions',      tileZ: 7  },
  { z: 9,  name: 'Metro',       desc: 'Metro area',   tileZ: 9  },
  { z: 11, name: 'City',        desc: 'City view',    tileZ: 11 },
  { z: 13, name: 'District',    desc: 'Neighborhood', tileZ: 13 },
  { z: 15, name: 'Streets',     desc: 'Street level', tileZ: 15 },
  { z: 17, name: 'Block',       desc: 'Buildings',    tileZ: 17 },
